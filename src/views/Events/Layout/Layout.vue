                        ...
                        <v-row class="py-0">
                            <v-col cols="12" md="12" class="pa-0" >
                                ...
                                >
                                    ...
                                    <v-card-title
                                        class="fill-height align-end  pb-5 white--text"
                                    >
                                        <p>
