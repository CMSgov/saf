<template>
  <v-content :class="$vuetify.theme.dark == true ? 'blank' : 'grey lighten-5'">
    <v-snackbar :timeout="5000" v-model="snackbarSuccess">
    ...
    <v-snackbar :timeout="5000" v-model="removeSuccess" bottom right>
      Team Member Removed Successfully
      <v-btn color="pink" text @click="removeSuccess = false">
        Close
      </v-btn>
    </v-snackbar>
                    ...
                    <v-row class="">
                      ...
                      >
                        ...
                        >
                          ...
                          <p class="mt-0 mb-0  mt-0" style="font-size:80%">
                            {{ item.designation }}
                          </p>
