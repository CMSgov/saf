  ...
  <v-content :class="$vuetify.theme.dark == true ? 'blank' : 'grey lighten-5'">
    <v-container fluid class="text-center ">
      <v-snackbar :timeout="5000" v-model="snackbarSuccess" bottom right>
        ...
        <v-btn color="pink" text @click="snackbarSuccess = false">
          Close
        </v-btn>
      </v-snackbar>
      ...
      <v-row justify="center" align="center">
        <v-col cols="12" md="11">
          <v-toolbar class="elevation-1">
            ...
            <editTeam
              :teamData="teamData"
              v-on:editedSuccess="editedSuccessFun"
              class="mr-2"
              v-if="showTeamData"
            />
            &nbsp;
            <removeTeam
              class="mr-1"
              v-if="showTeamData"
              :teamData="{ id: $route.params.id, name: teamData.name }"
            />
            ...
            <v-tooltip bottom v-if="showTeamData">
              <template v-slot:activator="{ on }">
                <v-btn
                  ...
                  v-on="on"
                  target="_blank"
                  v-on:click="showPublicURL($route.params.id)"
                >
          ...
          <v-container fluid>
            <v-row>
              ...
              >
                <v-avatar size="120">
                  <img
                    ...
                    :lazy-src="getImgUrl(teamData.image)"
                    alt=""
                  />
                </v-avatar>

                <p class="mt-3 mb-0  mb-0" style="font-size:120%">
                  {{ teamData.name }}
                </p>
                <p class="mt-1 mb-0  mt-0" style="font-size:100%">
              ...
              >
                ...
                <p class="mt-0 mb-0  mt-0" style="font-size:110%">
                  {{ teamData.email }}
                </p>
                ...
                <p class="mt-1 mb-0  mt-0" style="font-size:110%">
                  <span
                    ...
                    v-for="(slink, i) in teamData.socialLinks"
                    :key="i"
                    class="mr-1"
                  >
                    <a
                    ...
                    >
                      <v-chip small style="text-transform: uppercase;">{{
                        i
                      }}</v-chip>
                    </a>
                  </span>
