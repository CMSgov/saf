  ...
  <v-dialog v-model="dialog" width="700">
    <template v-slot:activator="{ on }">
      ...
      >
        ...
        <p class=" mt-1 mb-0" style="font-size:90%">{{data.data.local_date | dateFilter}}</p>
        <p class=" ma-0 mt-0" style="font-size:120%;">{{data.data.name }}</p>
        <p class=" mt-0 mb-0" style="font-size:90%;">{{data.data.local_time}}</p>
        <p class=" mt-0 mb-0" style="font-size:90%;">{{data.data.venue.name }}</p>
    ...
    <v-card color v-if="dialog">
      ...
      <v-card-text class="pa-5">
        ...
        <p class=" mt-3 mb-0" style="font-size:110%">
          <b>Venue:</b>
